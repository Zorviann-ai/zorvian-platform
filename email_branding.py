"""Professional HTML email presentation for Zorvian Core.
...
Zorvian remains the discreet technology provider in the footer.
"""
...
def render_email(*, title: str, body: str, client_name: str = "Zorvian", cta_label: str | None = None, cta_url: str | None = None, preheader: str = "") -> str:
    brand = escape(client_name.strip() or "Zorvian")
