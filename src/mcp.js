...
const tools = [
  {
    name: 'crm_status',
    title: 'CRM status',
    description: 'Use this when you need to confirm that the Caelomere CRM connection is live and writable.',
  ...
  },
  {
    ...
    description: 'Use this when you need to see the user’s current Caelomere projects, briefs, statuses, and next actions.',
  ...
  },
  {
    ...
    description: 'Use this when the user asks to create a new project in Caelomere CRM.',
  ...
  },
  {
    ...
    description: 'Use this when the user asks to change a project brief, status, category, or next action in Caelomere CRM.',
  ...
  },
  {
    ...
    description: 'Use this when you need to see outstanding or completed Caelomere CRM tasks.',
  ...
  },
  {
    ...
    description: 'Use this when the user asks to add a concrete task to Caelomere CRM.',
  ...
  },
  {
    ...
    description: 'Use this when the user asks to update, complete, reprioritise, or add results/notes to a Caelomere CRM task.',
  ...
  },
  {
    ...
    description: 'Use this when you need to see leads, clients, suppliers, or partners stored in Caelomere CRM.',
  ...
  },
  {
    ...
    description: 'Use this when the user asks to add a lead, client, supplier, or partner to Caelomere CRM.',
  ...
  },
  {
    ...
    description: 'Use this when you need the latest Caelomere CRM history so you can continue work without losing the thread.',
...
async function callTool(name, args, env) {
  ...
  if (name === 'crm_status') {
    ...
    return toolResult('Caelomere CRM is connected and writable.', { ok: true, tenant: t, projects: Number(p?.n || 0), open_tasks: Number(q?.n || 0) });
  }
  ...
  if (name === 'create_project') {
    ...
    return toolResult(`Created project “${args.name}” in Caelomere CRM.`, { id, created: true });
  }
  ...
  if (name === 'create_task') {
    ...
    return toolResult(`Created task “${args.title}” in Caelomere CRM.`, { id, created: true });
  }
  if (name === 'update_task') {
  ...
  if (name === 'create_contact') {
    ...
    return toolResult(`Created contact “${args.name}” in Caelomere CRM.`, { id, created: true });
  }
